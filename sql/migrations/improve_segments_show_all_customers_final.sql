-- =====================================================
-- MIGRATION: Improve Segments to Show All Customers (FINAL)
-- Author: Claude Code Assistant
-- Date: 2025-12-17
-- Description: Versión final corrigiendo tipos UUID
-- =====================================================
...
BEGIN
  ...
  -- Si NO hay filtros activos, devolver conteo total optimizado
  IF NOT has_active_filters THEN
    -- Query optimizado para TODOS los clientes únicos
    WITH all_customers AS (
      ...
      WHERE t_order.restaurant_id = p_restaurant_id
        ...
        AND uo.user_id::text NOT LIKE 'guest%' -- Cast UUID a text
      ...
      WHERE t.restaurant_id = p_restaurant_id
        ...
        AND pt.user_id NOT LIKE 'guest%' -- ya es text
    ...
    RAISE NOTICE 'Total customers (no filters): %', customer_count;
    RETURN customer_count;
  END IF;

  -- Si HAY filtros activos, usar la lógica completa existente
  ...
  -- Query completo con filtros (lógica original)
...
-- =====================================================
-- MIGRATION COMPLETED SUCCESSFULLY (TIPOS CORREGIDOS)
-- =====================================================

-- Corrección aplicada:
-- ✅ user_id::text NOT LIKE 'guest%' para campos UUID
-- ✅ Mantener user_id NOT LIKE 'guest%' para campos text
-- ✅ Misma corrección en ambos queries (sin filtros y con filtros)