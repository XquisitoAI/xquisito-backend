-- Agregar columna images a la tabla dish_order
-- Esta columna almacenará un arreglo de URLs de imágenes para cada platillo

-- 1. Agregar columna images (tipo TEXT[] para arreglo de strings)
ALTER TABLE dish_order
ADD COLUMN IF NOT EXISTS images TEXT[] DEFAULT '{}';

-- 2. Actualizar función create_dish_order para incluir images
...
BEGIN
    ...
    -- Crear el platillo con imágenes
    INSERT INTO dish_order (user_order_id, item, quantity, price, status, payment_status, images)
    VALUES (v_user_order_id, p_item, p_quantity, p_price, 'pending', 'not_paid', p_images)
