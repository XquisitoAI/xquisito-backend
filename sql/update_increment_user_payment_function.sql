-- Actualizar función increment_user_payment para que user_id sea VARCHAR(255)
-- en lugar de UUID, para que coincida con el tipo de la columna user_id en active_table_users
