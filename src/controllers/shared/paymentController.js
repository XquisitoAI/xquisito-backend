...
const { EcartPayService } = require("../../services/shared/ecartpayService");
const ecartPayService = require("../../services/shared/ecartpayService");
const tableService = require("../../services/flex-bill/flexBillService");
const { savePaymentMethodToUserOrder } = tableService;
const paymentTransactionService = require("../../services/shared/paymentTransactionService");
...
class PaymentController {
  ...
  async createPaymentTransaction(req, res) {
    try {
      ...
      try {
        const PaymentNotificationService = require("../../services/shared/paymentNotificationService");
