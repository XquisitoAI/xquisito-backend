const pickAndGoService = require("../../services/pick-and-go/pickAndGoService");
const socketEmitter = require("../../services/shared/socketEmitter");
const kitchenService = require("../../services/shared/kitchenService");
const {
  emitPrintJobForPickAndGoOrder,
} = require("../../services/shared/printJobService");
const whatsappService = require("../../services/shared/whatsappService");
...
class PickAndGoController {
  ...
  // POST /api/pick-and-go/orders/confirm - Crear orden, items y transacción de forma atómica
  async confirmOrder(req, res) {
    try {
      ...
      // Emitir trabajo de impresión para la cocina
