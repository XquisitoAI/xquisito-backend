...
const analyticsController = require("../../controllers/admin-portal/analyticsController");
...
router.get(
  "/debug/user-info",
  adminPortalAuth,
  analyticsController.debugUserInfo,
);
...
router.get(
  "/restaurants",
  adminPortalAuth,
  analyticsController.getUserRestaurants,
);
...
router.get(
  "/dashboard/complete",
  adminPortalAuth,
  analyticsController.getCompleteDashboardData,
);
 ...
 */
router.get(
  "/dashboard/active-orders/:restaurant_id",
  adminPortalAuth,
  analyticsController.getActiveOrders,
);
 ...
 */
router.get(
  "/dashboard/orders/:restaurant_id",
  adminPortalAuth,
  analyticsController.getActiveOrders,
);
...
router.get(
  ...
  adminPortalAuth,
  analyticsController.getTopSellingItem,
);
router.get(
  "/dashboard/all-selling-items",
  adminPortalAuth,
  analyticsController.getAllSellingItems,
);
 ...
 */
router.get(
  "/dashboard/summary/:restaurant_id",
  adminPortalAuth,
...
router.get(
  ...
  adminPortalAuth,
  analyticsController.getDashboardMetricsAllServices,
);
...
router.get(
  ...
  adminPortalAuth,
  analyticsController.getOrderItems,
);
